				      ...
				      <div className="row">
				        <div className="col-xl-3 col-md-6 col-sm-6 col-12">
				          <div className="footer-widget footer-about-widget">
				            ...
				            <p>Travel far, travel wide, travel deep, and find your soul.
								Wander often, wonder always.</p>
				            <div className="footer-address">
				              <ul>
				                ...
				                <li>
				                  ...
				                  <div className="footer-address-info">
				                    <p><a href="mailto:example@example.com">techpath@gmail.com</a></p>
				                  </div>
				                </li>
				              </ul>
				            </div>
