				...
				<div className="row">
					...
					<div className="about-us-img-wrap about-img-left">
						...
						<div className="ltn__video-img ltn__animation-pulse1">
							<img src={publicUrl+"assets/img/others/8.jpg"} alt="video popup bg image" />
							<a className="ltn__video-icon-2 ltn__video-icon-2-border---" href="https://www.youtube.com/embed/dB0NdTM_UTQ?autoplay=1&showinfo=0" data-rel="lightcase:myCollection">
