			  ...
			  <div className="container">
			    ...
			    <div className="row ltn__product-slider-item-three-active slick-arrow-1">
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            <Link to="/product-details"><img src={publicUrl+"assets/img/1.jpg"} alt="#" /></Link>
			          ...
			          <div className="product-info-bottom">
			            <div className="real-estate-agent go-top">
			              <div className="agent-img">
			                <Link to="/team-details"><img src={publicUrl+"assets/img/2.jpg"} alt="#" /></Link>
			              </div>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            <Link to="/product-details"><img src={publicUrl+"assets/img/hdhome/20(6).jpg"} alt="#" /></Link>
			            <div className="product-badge">
			              <ul>
			          ...
			          <div className="product-info-bottom">
			            <div className="real-estate-agent go-top">
			              <div className="agent-img">
			                <Link to="/team-details"><img src={publicUrl+"assets/img/hdhome/20(9).jpg"} alt="#" /></Link>
			              </div>
			              <div className="agent-brief">
			                <h6><Link to="/team-details">William Seklo</Link></h6>
			                <small>Estate Agents</small>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            <Link to="/product-details"><img src={publicUrl+"assets/img/hdhome/20(11).jpg"} alt="#" /></Link>
			            <div className="product-badge">
			              <ul>
			                <li className="sale-badge bg-green">For Rent</li>
			              </ul>
			          ...
			          <div className="product-info-bottom">
			            <div className="real-estate-agent go-top">
			              <div className="agent-img">
			                <Link to="/team-details"><img src={publicUrl+"assets/img/hdhome/20(16).jpg"} alt="#" /></Link>
			              </div>
			              <div className="agent-brief">
			                <h6><Link to="/team-details">William Seklo</Link></h6>
			                <small>Estate Agents</small>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            <Link to="/product-details"><img src={publicUrl+"assets/img/hdhome/20(15).jpg"} alt="#" /></Link>
			            <div className="product-badge">
			              <ul>
			                <li className="sale-badge bg-green">For Rent</li>
			              </ul>
			          ...
			          <div className="product-info-bottom">
			            <div className="real-estate-agent go-top">
			              <div className="agent-img">
			                <Link to="/team-details"><img src={publicUrl+"assets/img/hdhome/20(20).jpg"} alt="#" /></Link>
			              </div>
			              <div className="agent-brief">
			                <h6><Link to="/team-details">William Seklo</Link></h6>
			                <small>Estate Agents</small>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            <Link to="/product-details"><img src={publicUrl+"assets/img/hdhome/20(21).jpg"} alt="#" /></Link>
			            <div className="product-badge">
			              <ul>
			                <li className="sale-badge bg-green">For Rent</li>
			              </ul>
			          ...
			          <div className="product-info-bottom">
			            <div className="real-estate-agent go-top">
			              <div className="agent-img">
			                <Link to="/team-details"><img src={publicUrl+"assets/img/hdhome/20(1).jpg"} alt="#" /></Link>
			              </div>
			              <div className="agent-brief">
			                <h6><Link to="/team-details">William Seklo</Link></h6>
			                <small>Estate Agents</small>
						...
						<div className="ltn__quick-view-modal-inner">
							...
							<div className="row">
								...
								<div className="modal-product-img">
									<img src={publicUrl+"assets/img/hdhome/20(3).jpg"} alt="#" />
								</div>
					...
					<div className="modal-content">
						...
						<div className="ltn__quick-view-modal-inner">
							...
							<div className="row">
								...
								<div className="modal-product-img">
									<img src={publicUrl+"assets/img/hdhome/20(8).jpg"} alt="#" />
								</div>
								</div>
								<div className="col-lg-6 col-12">
